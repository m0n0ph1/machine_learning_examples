...
from scipy.stats import dirichlet, multivariate_normal as mvn, wishart
...
def gmm(X, K, max_iter=100):
    ...
    for iter_idx in xrange(max_iter):
        ...
        costs[ iter_idx ] = get_cost(X, K, cluster_assignments, phi, alphas, mu_means, mu_covs, a, B, orig_alphas, orig_c,
                                     orig_a, orig_B)
